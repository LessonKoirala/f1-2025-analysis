...
def show_verstappen_analysis():
    ...
    def load_data():
        ...
        DATA_PATH = os.path.join(current_dir, "..", "cleaned_Csv", "Australia2025_VER_cleaned_sorted.csv")
    ...
    def main():
        ...
        st.title("🏎️ Verstappen Telemetry Analysis")
        st.markdown("### Formula 1 | Australia 2025 | Max Verstappen Performance Insight")
