...
def show_leclerc_analysis():
    ...
    def load_data():
        ...
        DATA_PATH = os.path.join(current_dir, "..", "cleaned_Csv", "Australia2025_LEC_cleaned_sorted.csv")
    ...
    def main():
        ...
        if compare_target != "None":
            ...
            fig_delta.add_trace(go.Scatter(x=ref_distance, y=delta_time, name=f"Delta (L{selected_lap}-L{ref_num})", fill='tozeroy', line=dict(color="#FFF200")), row=1, col=1)
